...
; Description:   Lesson 005 - Transmitting Strings
; ==============================================================================
...
; SUBROUTINE:  main
; ==============================================================================
; Description: Sets up stack pointer, calls UART init, and prints a string.
; ------------------------------------------------------------------------------
; Parameters:  None
; Returns:     None
; ==============================================================================
main:
  ...
  RCALL  uart_print_string             ; Call print string subroutine
.loop:
  RJMP   .loop                         ; Infinite loop to halt program
...
; ==============================================================================
; SUBROUTINE:  uart_print_string
; ==============================================================================
; Description: Prints a null-terminated string from Program Memory over UART.
;              Clobbers R16. Z register must point to the string.
; ------------------------------------------------------------------------------
; Parameters:  Z (R30:R31) = Pointer to null-terminated string in Flash
; Returns:     None
; ==============================================================================
uart_print_string:
...
; ==============================================================================
my_string:
  .asciz "Hello Serial World!\r\n"     ; Null-terminated string stored in Flash
